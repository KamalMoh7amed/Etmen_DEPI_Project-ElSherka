...
{
    /// <summary>
    /// Full details ViewModel for a single emergency case.
    /// </summary>
    public class EmergencyCaseDetailViewModel
    {
        // ── Case ──────────────────────────────────────
        ...
        public List<Etmen_BLL.DTOs.CriticalIntelligence.FamilyMemberChatDto> PatientFamilyMembers { get; set; } = new();

        // ── Computed helpers ──────────────────────────
        public int WaitingMinutes => (int)Math.Max(0, (DateTime.UtcNow - RequestedAt).TotalMinutes);
