    ...
    public sealed class AdminService : IAdminService
    {
        ...
        public async Task<ServiceResult<UserListItemDto>> GetUserByIdAsync(int userId)
        {
...

            {
                ...
                return ServiceResult<UserListItemDto>.Failure("حدث خطأ Ø£Ø«Ù†Ø§Ø¡ استرجاع Ø§Ù„Ù…Ø³ØªØ®Ø¯Ù….");
...

        {
...

            {
                ...
                return ServiceResult.Failure("حدث خطأ Ø£Ø«Ù†Ø§Ø¡ ØªØ­Ø¯ÙŠØ« Ø­Ø§Ù„Ø© Ø§Ù„Ù…Ø³ØªØ®Ø¯Ù….");
...

        {
...

            {
                ...
                if (dto.UserIds is null || dto.UserIds.Count == 0)
                    ...
                    return ServiceResult.Failure("Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø³ØªØ®Ø¯Ù…ÙŠÙ† Ù„Ø§ ÙŠÙ…ÙƒÙ† Ø£Ù† ØªÙƒÙˆÙ† فارغة.");
...

            {
                ...
                return ServiceResult.Failure("حدث خطأ Ø£Ø«Ù†Ø§Ø¡ ØªÙ†ÙÙŠØ° Ø§Ù„Ø¥Ø¬Ø±Ø§Ø¡ Ø§Ù„Ø¬Ù…Ø§Ø¹ÙŠ.");
...

        {
...

            {
                ...
                return ServiceResult.Failure("حدث خطأ Ø£Ø«Ù†Ø§Ø¡ حذف Ø§Ù„Ù…Ø³ØªØ®Ø¯Ù….");
...

        {
...

            {
                ...
                return ServiceResult<ProviderListItemDto>.Failure("حدث خطأ Ø£Ø«Ù†Ø§Ø¡ استرجاع Ø§Ù„Ù…ÙˆÙØ±.");
...

        {
...

            {
                ...
                if (dto.Latitude < -90 || dto.Latitude > 90)
                    ...
                    return ServiceResult.Failure("خط Ø§Ù„Ø¹Ø±Ø¶ ÙŠØ¬Ø¨ Ø£Ù† ÙŠÙƒÙˆÙ† Ø¨ÙŠÙ† -90 Ùˆ 90.");



                if (dto.Longitude < -180 || dto.Longitude > 180)

                    return ServiceResult.Failure("خط Ø§Ù„Ø·ÙˆÙ„ ÙŠØ¬Ø¨ Ø£Ù† ÙŠÙƒÙˆÙ† Ø¨ÙŠÙ† -180 Ùˆ 180.");
...

            {
                ...
                return ServiceResult.Failure("حدث خطأ Ø£Ø«Ù†Ø§Ø¡ Ø¥Ù†Ø´Ø§Ø¡ Ø§Ù„Ù…ÙˆÙØ±.");
...

        {
...

            {
                ...
                return ServiceResult.Failure("حدث خطأ Ø£Ø«Ù†Ø§Ø¡ ØªØ­Ø¯ÙŠØ« Ø§Ù„Ù…ÙˆÙØ±.");
...

        {
...

            {
                ...
                return ServiceResult.Failure("حدث خطأ Ø£Ø«Ù†Ø§Ø¡ حذف Ø§Ù„Ù…ÙˆÙØ±.");
...

        {
...

            {
                ...
                return ServiceResult<AdminDashboardDto>.Failure("حدث خطأ Ø£Ø«Ù†Ø§Ø¡ استرجاع Ù„ÙˆØ­Ø© Ø§Ù„ØªØ­ÙƒÙ….");
...

        {
...

            {
                ...
                return ServiceResult<PaginatedResult<AdminReportDto>>.Failure("حدث خطأ Ø£Ø«Ù†Ø§Ø¡ استرجاع Ø§Ù„ØªÙ‚Ø§Ø±ÙŠØ±.");
...

        {
...

            {
                ...
                return ServiceResult<AdminCrisisDto>.Failure("حدث خطأ Ø£Ø«Ù†Ø§Ø¡ استرجاع Ù…Ø¹Ù„ÙˆÙ…Ø§Øª Ø§Ù„Ø£Ø²Ù…Ø©.");
...

        {
...

            {
                ...
                return ServiceResult<List<ActivityLogDto>>.Failure("حدث خطأ Ø£Ø«Ù†Ø§Ø¡ استرجاع Ø§Ù„Ø³Ø¬Ù„Ø§Øª.");
...

        {
...

            {
                ...
                return ServiceResult<SystemConfigDto>.Failure("حدث خطأ Ø£Ø«Ù†Ø§Ø¡ استرجاع إعدادات Ø§Ù„Ù†Ø¸Ø§Ù….");
...

        {
...

            {
                ...
                if (dto.MaxLoginAttempts < 1)
                    ...
                    return ServiceResult.Failure("حد Ù…Ø­Ø§ÙˆÙ„Ø§Øª ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø¯Ø®ÙˆÙ„ ÙŠØ¬Ø¨ Ø£Ù† ÙŠÙƒÙˆÙ† Ø£ÙƒØ¨Ø± Ù…Ù† 0.");
...

            {
                ...
                return ServiceResult.Failure("حدث خطأ Ø£Ø«Ù†Ø§Ø¡ ØªØ­Ø¯ÙŠØ« إعدادات Ø§Ù„Ù†Ø¸Ø§Ù….");
...

        {
...

            {
                ...
                return ServiceResult.Failure("حدث خطأ Ø£Ø«Ù†Ø§Ø¡ Ø§Ù„Ù…ÙˆØ§ÙÙ‚Ø© Ø¹Ù„Ù‰ Ø§Ù„Ø£Ø²Ù…Ø©.");
...

        {
...

            {
                ...
                if (string.IsNullOrWhiteSpace(reason))
                    ...
                    return ServiceResult.Failure("ÙŠØ¬Ø¨ ØªÙ‚Ø¯ÙŠÙ… سبب Ø§Ù„Ø±ÙØ¶.");
...

            {
                ...
                return ServiceResult.Failure("حدث خطأ Ø£Ø«Ù†Ø§Ø¡ رفض Ø§Ù„Ø£Ø²Ù…Ø©.");
...

        {
...

            {
                ...
                return ServiceResult.Failure("حدث خطأ Ø£Ø«Ù†Ø§Ø¡ ØªØ­Ø¯ÙŠØ« Ø­Ø§Ù„Ø© Ø§Ù„Ø£Ø²Ù…Ø©.");
