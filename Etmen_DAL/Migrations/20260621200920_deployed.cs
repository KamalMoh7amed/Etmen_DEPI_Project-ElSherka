        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmbulanceCapacity = table.Column<int>(type: "int", nullable: true),
                    AvailableAmbulances = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OnboardingDataJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveShift = table.Column<int>(type: "int", nullable: false),
                    IsInvitationAccepted = table.Column<bool>(type: "bit", nullable: false),
                    InvitationSenderUserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StaffProfiles_HealthcareProviders_HealthcareProviderId",
            ...
            migrationBuilder.CreateTable(
                name: "DoctorProviders",
                columns: table => new
                {
                    DoctorProfileId = table.Column<int>(type: "int", nullable: false),
                    HealthcareProviderId = table.Column<int>(type: "int", nullable: false),
                    IsEmergencyDoctor = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    IsOwner = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    AffiliationRole = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorProviders", x => new { x.DoctorProfileId, x.HealthcareProviderId });
                    table.ForeignKey(
                        name: "FK_DoctorProviders_DoctorProfiles_DoctorProfileId",
                        column: x => x.DoctorProfileId,
                        principalTable: "DoctorProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DoctorProviders_HealthcareProviders_HealthcareProviderId",
                        column: x => x.HealthcareProviderId,
                        principalTable: "HealthcareProviders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ReminderSentOneDayBefore = table.Column<bool>(type: "bit", nullable: false),
                    ReminderSentTwoHoursBefore = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_HealthcareProviders_HealthcareProviderId",
                        column: x => x.HealthcareProviderId,
                        principalTable: "HealthcareProviders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StaffActivityLogs_StaffProfiles_StaffProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriorityScore = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    AutoEscalatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EscalationReason = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    DoctorsNotified = table.Column<bool>(type: "bit", nullable: false),
                    DoctorsNotifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    AssignedDoctorUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ...
                    PatientRecommendations = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    FamilyRecommendations = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    PrescribedMedications = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmergencyRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmergencyRequests_AspNetUsers_AssignedDoctorUserId",
                        column: x => x.AssignedDoctorUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_EmergencyRequests_AspNetUsers_RespondedByUserId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmergencyRequests_RiskAssessments_RiskAssessmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorProviders_HealthcareProviderId",
                table: "DoctorProviders",
                column: "HealthcareProviderId");

            migrationBuilder.CreateIndex(
                name: "IX_EmergencyRequests_AssignedDoctorUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmergencyRequests_IsAutoGenerated",
                table: "EmergencyRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmergencyRequests_PriorityScore",
                table: "EmergencyRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmergencyRequests_RespondedByUserId",
                table: "EmergencyRequests",
                column: "RespondedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_EmergencyRequests_RiskAssessmentId",
                table: "EmergencyRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_HealthcareProviderId",
                table: "Reviews",
                column: "HealthcareProviderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffActivityLogs_StaffProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffProfiles_HealthcareProviderId",
                table: "StaffProfiles",
                column: "HealthcareProviderId");
        }
