...
> لقطات حقيقية من النظام تُظهر الواجهات الرئيسية للمستخدمين.

### 🗂️ إدارة الملف الطبي والشخصي
![إدارة الملف الطبي والشخصي](docs/screenshots/01_patient_profile.png)

---

### 📋 نموذج تقييم المخاطر الصحية
![نموذج تقييم المخاطر الصحية](docs/screenshots/02_risk_assessment_form.png)

---

### 🚨 نتيجة تقييم المخاطر (حالة طوارئ)
![نتيجة تقييم المخاطر](docs/screenshots/03_risk_result.png)

---

### 💊 تفاصيل المؤشرات الحيوية والتوصيات
![تفاصيل المؤشرات الحيوية والتوصيات](docs/screenshots/04_risk_details.png)

---

### 📜 سجل الفحوصات الطبية وتقييم المخاطر
![سجل الفحوصات الطبية](docs/screenshots/05_medical_history.png)

---

### 🔬 التحاليل المخبرية والتقارير الطبية بالذكاء الاصطناعي (OCR)
![نتائج التحاليل والتقارير الطبية](docs/screenshots/06_ocr_lab_results.png)

---

### 🗺️ البحث عن المراكز والعيادات القريبة
![البحث عن المراكز والعيادات القريبة](docs/screenshots/07_nearby_hospitals.png)

---

### 🚑 طلب الإسعاف العاجل والمرشد الصوتي للإسعافات الأولية
![طلب الإسعاف العاجل](docs/screenshots/08_emergency_request.png)

---

### 🏥 الملف الطبي للحالة الطارئة (واجهة موظف المستشفى)
![الملف الطبي للحالة الطارئة](docs/screenshots/09_hospital_emergency_file.png)

---

### 📡 تتبع سيارة الإسعاف حياً (Live GPS Tracking)
![تتبع سيارة الإسعاف](docs/screenshots/10_ambulance_live_tracking.png)

---

### 🏥 صندوق حالات الطوارئ (واجهة الطبيب المناوب)
![صندوق حالات الطوارئ](docs/screenshots/11_emergency_queue_doctor.png)

---

### 🏠 لوحة تحكم المريض مع حالة طوارئ نشطة
![لوحة تحكم المريض](docs/screenshots/12_patient_dashboard_emergency.png)

---

### 💬 المحادثة المباشرة بين المريض والطبيب
![المحادثة مع الطبيب](docs/screenshots/13_doctor_patient_chat.png)

---

### 🤖 المستشار الصحي الذكي (AI Health Consultant)
![المستشار الصحي الذكي](docs/screenshots/14_ai_health_consultant.png)

---

### 📋 تفاصيل الحالة الطارئة (واجهة الطبيب)
![تفاصيل الحالة الطارئة](docs/screenshots/15_emergency_case_details.png)

---

### 📝 توصيات الطبيب وتعليمات الحالة
![توصيات الطبيب](docs/screenshots/16_doctor_recommendations.png)

---

### ✅ تقرير تسليم الحالة وتأكيد الوصول للمستشفى
![تقرير تسليم الحالة](docs/screenshots/17_emergency_delivery_report.png)

---

### 💓 لوحة تحكم المريض — القياسات الحيوية والخدمات
![لوحة تحكم المريض - القياسات](docs/screenshots/18_patient_dashboard_vitals.png)

---

### 📅 لوحة تحكم المريض — المواعيد والتنبيهات وسجل المخاطر
![لوحة تحكم المريض - المواعيد](docs/screenshots/19_patient_dashboard_history.png)
